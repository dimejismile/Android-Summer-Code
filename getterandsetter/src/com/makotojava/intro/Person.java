...
public class Person {
	...
	public void printAudit(Logger l) { 
		StringBuilder sb = new StringBuilder(); printAudit(sb); l.info(sb.toString());}
	...
	public String toString() {
		return "Person [l=" + l + ", name=" + name + ", age=" + age + ", height=" + height + ", weight=" + weight
				+ ", eyeColor=" + eyeColor + ", gender=" + gender + ", getL()=" + getL() + ", getName()=" + getName()
				+ ", getAge()=" + getAge() + ", getHeight()=" + getHeight() + ", getWeight()=" + getWeight()
				+ ", getEyeColor()=" + getEyeColor() + ", getGender()=" + getGender() + ", hashCode()=" + hashCode()
